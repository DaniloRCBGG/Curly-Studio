...
// Guia de uso do estoque (texto do documento "Como usar o estoque", aprovado pelo Danilo em 26/09/2026).
// Componente de servidor: o texto só vai na página do painel, que exige login da equipe.
